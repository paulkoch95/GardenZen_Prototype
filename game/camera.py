...
class ScrollingCamera(pygame.sprite.Group):
    ...
    def input(self):
        ...
        if pygame.mouse.get_pressed()[0]:
            self.camera_offset += pygame.math.Vector2(self.x_m//self.zoom_factor, self.y_m//self.zoom_factor)
    ...
    def render_context(self) -> None:
        ...
        scaled_surface = pygame.transform.scale(self.intermediate_surface, surf_size*self.zoom_factor)
